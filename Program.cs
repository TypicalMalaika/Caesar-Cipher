...
namespace CaesarCipher
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.Write("Secret Messafge: ");
      string input = Console.ReadLine();

      char[] secretMessage = input.ToCharArray();
      char[] encyptedMessage = new char[secretMessage.Length];
      ...
      for (int i = 0; i < secretMessage.Length; i++)
      {
        ...
        encyptedMessage[i] = letterEncoded;
      }

      string encodedString = String.Join("",  encyptedMessage);
